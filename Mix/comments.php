...
<!--                <img class="avatar" src="--><?php //echo $avatar ?><!--" alt="--><?php //echo $comments->author; ?><!--"/>-->
                <img class="avatar" src="<?php echo $GLOBALS['assetURL'] . 'img/icon/' . rand(1, 10) . '.png' ?>" alt="<?php echo $comments->author; ?>"/>
                <div class="line"></div>
                <div class="comment_main">
                    <div class="comment_meta">
                        <span class="comment_author"><?php echo $author ?></span> <span
                                class="comment_time"><?php $comments->date('y-m-d'); ?></span><span
                                class="comment_reply"><i class="fa fa-reply" aria-hidden="true"
                                                         name="回复"><?php $comments->reply() ?></i></span>
                    </div>

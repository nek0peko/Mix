<div id="overlay" class="display_none">
    <div class="Overlay_container__1owmA" style="opacity: 1;">
        <div>
            <div class="Overlay_overlay__2YOqK" style="opacity: 1;"></div>
        </div>
    </div>
</div>
<div id="headerr" class="Header_drawer__iQn1p global-drawer">
    <div id="close" class="pb-4 text-right"><span class="p-4 inline-block -mr-5 -mt-4">
    ...
    <div class="Header_link-section__1JFc9 global-link-section">
        <a href="<?php Helper::options()->siteUrl() ?>">
            <div class="Header_parent__3EA6A global-parent">
                <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="dot-circle"
                     class="svg-inline--fa fa-dot-circle fa-w-16 " role="img" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 512 512">
                    <path fill="currentColor"
    ...
    <div class="Header_link-section__1JFc9 global-link-section">
        <a href="#">
            <div class="Header_parent__3EA6A global-parent">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="glasses"
                     class="svg-inline--fa fa-glasses fa-w-18 " role="img" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 576 512">
                    <path fill="currentColor"

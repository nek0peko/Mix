...
<header class="assets" id="header">
    <div class="jsx-685620294 head-btn"
         id="<?php if ($this->options->sideBarStyle == 1): ?>btn_active<?php elseif ($this->options->sideBarStyle == 2): ?>btn_sidebar<?php endif; ?>"
         style="display: flex; align-items: center; justify-content: center; padding: 1em; cursor: pointer;">
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="list-ul"
             class="svg-inline--fa fa-list-ul fa-w-16 " role="img" xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 512 512">

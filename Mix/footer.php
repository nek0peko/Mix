    ...
    <div class="wrap">
        <div class="row" style="padding-bottom:18px">
            <div class="col-m-6 left to-center">
                <p>Copyright © 2022
                    <a href="<?php Helper::options()->siteUrl() ?>" target="_blank"
                       rel="noopener"><?php $this->author(); ?></a>
                </p>
                <p>Powered by
                    ...
                    <a href="https://github.com/nek0peko/Mix" rel="noopener" title="Mix-2.0.0 By Wibus / Edited By nek0peko">
                        Typecho-Mix </a>
                    <!--                    <svg-->
                    ...
                    <!--                        </path>-->
                    <!--                    </svg>-->
                    <!--                    <span title="Stay hungry. Stay foolish. -- Steve Jobs">Stay hungry. Stay foolish.</span>-->
            ...
            <div class="col-m-6 right to-center">
                <?php if (!empty($this->options->Show_what_1) && in_array('ShowAly', $this->options->Show_what_1)): ?>
                    <p><?php echo online_users() ?>个小伙伴正在浏览</p>
...
<script>
    document.body.classList.remove("loading");
    console.log('%c Typecho %c v1.2.0 ',
        'padding: 2px 1px; border-radius: 3px 0 0 3px; color: #fff; background: #606060; font-weight: bold;',
        'padding: 2px 4px; border-radius: 0 3px 3px 0; color: #fff; background: #42c02e; font-weight: bold;')
    console.log("%c Mix v" + window.MIX_CONFIG.VERSION + " By Wibus / Edited By nek0peko ",
